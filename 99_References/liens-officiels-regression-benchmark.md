...
- **Aurélien Géron — *ML avec scikit-Learn (3ᵉ éd.)*** ch. 4 (régression linéaire), ch. 7 (ensembles)
- **MAE vs RMSE** : <https://medium.com/human-in-a-machine-world/mae-and-rmse-which-metric-is-better-e60ac3bde13d>

## Grille de décision

- **`10_Architecture_Cadrage_Produit/grille-decision-c4-reference.md`** — version initiale du parcours, à enrichir en restitution mercredi

## Aide-mémoire

- **`03_ML_Modelisation_Evaluation/cheatsheet-algos-ml-fr.pdf`** — sélection des algos ML par type de problème (familles, forces/limites) ; les 3 familles du benchmark y sont repérées « TRIO M4B1 »
